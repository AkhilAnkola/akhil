...
const Work = (props) => {
    return(
        <>
            ...
            <Card cimg={web10} cheading="Hidden Colors" ctext="IT's looks simple but it's not, Here I use two images which are placed on each other, mouse is just hide above image." btnname="Show project"/>
