    ...
    return(
        <>
            ...
            <div className="container-fluid">
                <NavLink className="navbar-brand" to="/Home">Akhil Ankola</NavLink>
                ...
                <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                    ...
                    <NavLink activeClassName='active-menu' className="nav-link active" aria-current="page" to="/Home">Home</NavLink>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                    <NavLink activeClassName='active-menu' className="nav-link" to="/Work">Work</NavLink>
                    </li>
                    <li className="nav-item">
